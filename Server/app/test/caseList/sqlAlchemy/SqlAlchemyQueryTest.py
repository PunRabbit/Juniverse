...
from Server.app.infra.db.sqlAlchemy.SqlAlchemy import SqlAlchemyQueryModule


class SqlAlchemyQueryTest(TestCase, CustomCaseTest):
    def test_create_connection_with_name(self):
        test_db_connection: QueryDBModel = SqlAlchemyQueryModule()
